"""Helper utilities for preparing tool configurations."""
...
def resolve_tool_config(
    ...
    """Return Anthropic-formatted tool configuration if tools are enabled."""
    ...
    return ToolManager.get_provider_tools(tool_list, ModelProvider.ANTHROPIC)
