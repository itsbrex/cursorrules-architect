"""Helper utilities for preparing xAI tool configurations."""
...
def resolve_tool_config(
    ...
    *,
    ...
    """Return xAI-formatted tool configuration if tools are enabled."""
    if not allow_tools:
        return None
    ...
    return ToolManager.get_provider_tools(tool_list, ModelProvider.XAI)
